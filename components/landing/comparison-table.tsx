...
export function ComparisonTable() {
  return (
    <FadeIn
      delay={0.2}
      className="max-w-5xl mx-auto overflow-hidden rounded-2xl border border-[#E7E5E4] shadow-xl bg-white backdrop-blur-md"
    >
      <div className="grid grid-cols-2 bg-[#F8F7F4] p-4 sm:p-6 font-bold text-base sm:text-xl border-b border-[#E7E5E4]">
        <div className="text-[#78716C] pl-4">Others show</div>
      ...
      {comparisonData.map((row, i) => (
        <motion.div
          ...
          className="grid grid-cols-2 p-4 sm:p-6 border-b border-[#E7E5E4] last:border-0 hover:bg-[#F8F7F4]/50 transition-colors group"
        >
          <div className="flex items-center gap-2 sm:gap-4 text-[#78716C] group-hover:text-[#1C1917] transition-colors">
          ...
          <div className="flex items-center gap-2 sm:gap-4 font-bold text-[#1C1917]">
