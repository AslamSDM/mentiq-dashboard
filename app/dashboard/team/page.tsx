...
import { Users, Mail, Crown, Shield, Eye, UserX, Send, X, RefreshCw, ArrowUpCircle } from "lucide-react";
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>
                  Current plan: <span className="font-semibold capitalize">{teamInfo.tier}</span>
                </CardDescription>
              </div>
              <div className="text-right">
                <div className={`text-3xl font-bold ${getUsageColor()}`}>
                  {totalUsers} / {teamInfo.limit === 0 ? "∞" : teamInfo.limit}
                </div>
            ...
            <CardContent>
              <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4 flex items-start gap-3">
                ...
                <div className="flex-1">
                  <p className="font-semibold text-yellow-900 dark:text-yellow-100">Team limit reached</p>
        ...
        <Card>
          ...
          <CardContent>
            <form onSubmit={handleInvite} className="flex gap-4">
              ...
              <Select value={inviteRole} onValueChange={setInviteRole} disabled={submitting || isAtLimit}>
              ...
              <Button type="submit" disabled={submitting || isAtLimit}>
      ...
      <Dialog open={showUpgradeDialog} onOpenChange={setShowUpgradeDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Your current plan ({teamInfo.tier}) is limited to {teamInfo.limit} team members.
              Upgrade to add more members to your team.
            </DialogDescription>
          </DialogHeader>
          <div className="py-4">
            <p className="text-sm text-muted-foreground">
              Current usage: <span className="font-semibold">{totalUsers} / {teamInfo.limit}</span>
            </p>
          </div>
          <DialogFooter>
      ...
      <AlertDialog open={!!memberToRemove} onOpenChange={() => setMemberToRemove(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to remove <strong>{memberToRemove?.full_name}</strong> from your team?
