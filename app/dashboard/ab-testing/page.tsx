          ...
          <TabsContent value="experiments" className="space-y-6">
            <div className="grid gap-4 md:grid-cols-4">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">
                    {experimentResults?.summary.totalVisitors.toLocaleString() ||
                      0}
                  </div>
                  <p className="text-xs text-muted-foreground">
                    In selected test
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">
                    {experimentResults
                      ? (
                          experimentResults.summary.conversionRate * 100
                        )?.toFixed(2) + "%"
                      : "0%"}
                  </div>
                            ...
                            <div className="space-y-4">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-muted-foreground">
                                  {(
                                    variant.confidenceInterval[0] * 100
                                  )?.toFixed(2)}
                                  % -{" "}
                                  {(
                                    variant.confidenceInterval[1] * 100
                                  )?.toFixed(2)}
                                  %
                                </p>
                              </div>
              ...
              <>
                <div className="grid gap-4 md:grid-cols-4">
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="text-2xl font-bold">
                        {
                          adoptionData.filter((f) => f.adoption_rate >= 60)
                            .length
                        }
                      </div>
                      <p className="text-xs text-muted-foreground">
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="text-2xl font-bold">
                        {
                          adoptionData.filter((f) => f.adoption_rate < 40)
                            .length
                        }
                      </div>
                      <p className="text-xs text-muted-foreground">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Adoption rates and user engagement for all tracked
                      features
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
